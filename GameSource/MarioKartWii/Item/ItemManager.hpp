...
public:
    ...
    Item::Obj* CreateItemDirect(ItemObjId item, Vec3& pos, Vec3& velocityMaybe, u8 playerId); //80799fbc
    Item::Obj* GenerateItemDirect(ItemObjId item, Vec3& pos, Vec3& velocityMaybe, u8 playerId); //8079a12c
